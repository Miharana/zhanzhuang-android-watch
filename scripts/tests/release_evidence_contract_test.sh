...
require_text "$checks" '1000011'
require_text "$checks" '2000013'
require_text "$checks" 'inspect_apk mobile "$mobile_apk" 28 1000011 0.1.11'
require_text "$checks" 'inspect_apk wear "$wear_apk" 33 2000013 0.1.12'
...
require_text "$checks" '0x40000100'
require_text "$checks" 'PROPERTY_SPECIAL_USE_FGS_SUBTYPE'
